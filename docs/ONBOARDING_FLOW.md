...
[1] Welcome（アプリ説明）
     ↓
[2] The Problem（デメリット説明）← 新規追加
     ↓
[3] Goal（何を取り戻すか）← 旧Motivation、方向性変更
     ↓
...
|------|----------|
| 2024-12-20 | 初版作成 |
| 2024-12-20 | v2: Step 1-3を大幅改訂。デメリット説明ページを追加 |
| 2024-12-20 | Step 6 (Alternative): コミットメント文の動的反映バグを記載 |
