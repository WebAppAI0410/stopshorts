...
| 要件 | 対応 |
|------|------|
| **価格の明示** | 全プランの価格・月額換算を明確に表示 |
| **トライアル条件** | 3日間、全機能利用可能、クレカ登録不要と明記 |
| **キャンセル方法** | いつでもキャンセル可能と明記 |
| **プライバシー** | 利用規約・プライバシーポリシーへのリンクを表示 |
...
|------|----------|
| 2025-12-20 | 初版作成 |
| 2025-12-20 | ダッシュボード設定（介入パターン選択）を追加 |
| 2025-12-20 | 課金モデルを追加 |
| 2025-12-20 | 課金モデル改訂: 機能制限版を廃止、3日間トライアルをデフォルトに、有料プラン間の機能差を廃止 |
| 2025-12-20 | 価格を業界標準に調整: 90日 ¥2,350 (20%OFF)、年間 ¥5,880 (50%OFF) |
